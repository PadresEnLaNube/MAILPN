(function($) {
    ...
    class MAILPN_Selector {
        ...
        createStructure() {
            const wrapper = $('<div class="mailpn-selector"></div>');
            const control = $('<div class="mailpn-selector__control"></div>');
            const valueContainer = $('<div class="mailpn-selector__value-container"></div>');
            const input = $('<input type="text" class="mailpn-selector__input" />');
            const indicator = $('<span class="mailpn-selector__indicator"><i class="material-icons-outlined mailpn-selector__indicator-icon">keyboard_arrow_down</i></span>');
            ...
            this.optionsContainer = $('<div class="mailpn-selector__options"></div>');
        ...
        bindEvents() {
            ...
            this.menu.on('click', '.mailpn-selector__option', (e) => {
        ...
        openMenu() {
            ...
            this.wrapper.find('.mailpn-selector__indicator-icon').text('keyboard_arrow_up');
        ...
        closeMenu() {
            ...
            this.wrapper.find('.mailpn-selector__indicator-icon').text('keyboard_arrow_down');
        }
        ...
        updateOptions() {
            ...
            options.each((_, option) => {
                ...
                const optionElement = $('<div class="mailpn-selector__option"></div>')
                    .text(label)
                    .data('value', value);
        ...
        filterOptions(searchTerm) {
            const options = this.optionsContainer.find('.mailpn-selector__option');
        ...
        addSelectedValue(value, label) {
            ...
            if (this.options.multiple) {
                const valueElement = $('<div class="mailpn-selector__multi-value"></div>');
                const labelElement = $('<span class="mailpn-selector__multi-value__label"></span>').text(label);
                ...
                removeButton.on('click', (e) => {
                    ...
                    this.optionsContainer.find('.mailpn-selector__option').each(function() {
                ...
                removeButton.on('click', (e) => {
                    ...
                    if (this.placeholder) {
                        this.input.hide();
                        this.valueContainer.append('<span class="mailpn-selector__placeholder">' + this.placeholder + '</span>');
                    }
                });
                valueElement.append(labelElement, removeButton);
                this.valueContainer.append(valueElement);
    ...
    $.fn.MAILPN_Selector = function(options) {
        return this.each(function() {
            if (!$(this).data('-selector')) {
                $(this).data('-selector', new MAILPN_Selector(this, options));
            }
        });
    };
    ...
    $(document).on('mousedown touchstart', function(e) {
        var $target = $(e.target);
        if (!$target.closest('.mailpn-selector').length) {
            $('.mailpn-selector__menu:visible').each(function() {
                var $menu = $(this);
                $menu.hide();
                $menu.closest('.mailpn-selector').find('.mailpn-selector__control').removeClass('-selector__control--is-open');
                $menu.closest('.mailpn-selector').find('.mailpn-selector__indicator-icon').text('keyboard_arrow_down');
            });
        }
    });
