(function($) {
    ...
    window.MAILPN_Tooltips = {
        init: function(selector) {
            selector = selector || '.mailpn-tooltip';
    ...
    $(document).on('mouseenter', '.mailpn-tooltip', function() {
        var $el = $(this);
        if ($el.attr('title') && !$el.attr('data-hostpn-tooltip')) {
            $el.attr('data-hostpn-tooltip', $el.attr('title'));
            $el.removeAttr('title');
    ...
    $(document).on('mouseleave', '.mailpn-tooltip', function() { hideTooltip(); });
    $(document).on('focusin', '.mailpn-tooltip', function() {
        var $el = $(this);
        if ($el.attr('title') && !$el.attr('data-hostpn-tooltip')) {
            $el.attr('data-hostpn-tooltip', $el.attr('title'));
            $el.removeAttr('title');
    ...
    $(document).on('focusout', '.mailpn-tooltip', function() { hideTooltip(); });
    $(document).on('touchstart', '.mailpn-tooltip', function(e) {
        var $el = $(this);
        if ($el.attr('title') && !$el.attr('data-hostpn-tooltip')) {
            $el.attr('data-hostpn-tooltip', $el.attr('title'));
            $el.removeAttr('title');
    ...
    $(document).ready(function() { MAILPN_Tooltips.init(); });
})(jQuery);
